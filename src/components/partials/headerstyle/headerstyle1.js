          ...
          <Navbar className="p-0" expand="lg">
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
              <Nav as="ul" className="ml-auto navbar-list iq-header">
                <Dropdown
                  as="li"
                  className="nav-item nav-icon search-content iq-search"
                >
                  <Dropdown.Toggle
                    as={CustomToggle}
                    href="#"
                        ...
                        <Link to="#" className="iq-sub-card">
                          <div className="media align-items-center">
                            ...
                            <div className="media-body ml-3">
                              ...
                              <small className="float-left iq-text font-size-12">
                                13 Jun
                              </small>
                            </div>
                          </div>
                        ...
                        <Link to="#" className="iq-sub-card">
                          <div className="media align-items-center">
                            ...
                            <div className="media-body ml-3">
                              ...
                              <small className="float-left text-white font-size-12">
                                5 Dec
                              </small>
                            </div>
                          </div>
                    ...
                    <Card className="shadow-none m-0">
                      <Card.Header className="d-flex justify-content-start bg-primary p-0">
                        <div className="bg-primary p-3">
                          ...
                          <span className="text-white font-size-12 iq-text">
                            Available
                          </span>
                        </div>
                      </Card.Header>
