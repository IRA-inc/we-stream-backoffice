...
import {GET_ALL_EVENTS,GET_ONE_EVENT,EDIT_EVENT,DELETE_EVENT,CREATE_EVENT,GET_PENDING_EVENTS,GET_MY_EVENTS,ACTIVATE_EVENT,CANCEL_EVENT,APPROVE_EVENT,OWNER_CREATE_EVENT,OWNER_EDIT_EVENT} from './actionTypes'

export const createEvent = makeActionCreator(CREATE_EVENT, 'payload');
export const ownerCreateEvent = makeActionCreator(OWNER_CREATE_EVENT, 'payload');
...
export const getPendingEvents = makeActionCreator(GET_PENDING_EVENTS, 'payload');
